...
export const strategyMeta = {
  ...
  configFields: {
    common: {
      ...
      rebalanceBars: { label: "Rebalance interval (bars)", type: "number" as const, default: 8640, min: 100 },
      stopAtrMult: { label: "Stop (ATR mult)", type: "number" as const, default: 10, min: 1, step: 0.5 },
