...
export const strategyMeta = {
  ...
  description: "Trades the spread between two highly correlated instruments (AUD/USD and NZD/USD, ~95% correlation). When their price ratio diverges beyond 2 standard deviations, bet on convergence.",
  configFields: {
    common: {
      instrumentA: { label: "Instrument A", type: "text" as const, default: "AUD_USD" },
      instrumentB: { label: "Instrument B", type: "text" as const, default: "NZD_USD" },
      ...
      lookback: { label: "Lookback (candles)", type: "number" as const, default: 1440, min: 1 },
    },
    backtest: {},
    live: {
